...
class EngineGLView extends GLSurfaceView {
    ...
    public static void cxEnginePlayFile(String file,boolean loop) {
    	engineSound.playEffect(file, loop, 1.0f, 1.0f, 1.0f);
    }
    ...
    public EngineGLView(Context context, boolean translucent, int depth, int stencil) {
        super(context);
    ...
    private static class Renderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        	engineSound = new EngineSound(appContext);
        	cxEngineInit();
        }
    }
}
