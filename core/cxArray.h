...
cxPointer *_e_ = NULL;                                                                      \
while((_a_) != NULL && (_e_ = (cxPointer)utarray_next((_a_)->uta, _e_)) != NULL)

#define CX_ARRAY_REVERSE(_a_,_e_)                                                           \
cxPointer *_e_ = NULL;                                                                      \
while((_a_) != NULL && (_e_ = (cxPointer)utarray_prev((_a_)->uta, _e_)) != NULL)

#define cxArrayLength(_a_)      (((_a_) == NULL) ? 0 : utarray_len((_a_)->uta))

#define cxArraySort(_a_,_cmp_)  if((_a_) != NULL){utarray_sort((_a_)->uta, _cmp_);}
